    ...
    <div class="content" style="min-height: 600px;">
      <div>
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item :to="{ path: '#/cookbook' }">菜谱大全</el-breadcrumb-item>
...
export default {
  ...
  methods:{
    getinfo(){
        this.$get('/getOneMenuInfo',{
          id:this.id
        }).then(response => {
          console.log(response);
          this.tableData = response.menu;
        })
    },

    queryFoodComment(){//食谱评论
      this.$get('/queryMenuComment',{
        id:this.id
      }).then(response =>{
        console.log(response);
